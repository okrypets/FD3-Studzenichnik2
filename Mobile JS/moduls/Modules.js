...
//let MobileClientsModel = new Modules();

//MobileClientsModel.setName(nameCompany);
//MobileClientsModel.getName();
//MobileClientsModel.setClients(clients);
//MobileClientsModel.setClient(client);
//MobileClientsModel.getClients();
//MobileClientsModel.isNewOrEditedClient();
//MobileClientsModel.updateName();
//MobileClientsModel.updateClient();
//MobileClientsModel.setNewId();
//MobileClientsModel.addClient();
//MobileClientsModel.getActiveClients();
//MobileClientsModel.getBlockedClients();
//MobileClientsModel.deleteClient();
